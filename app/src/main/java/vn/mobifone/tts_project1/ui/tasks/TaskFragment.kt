...
import vn.mobifone.tts_project1.data.SortOrder
import vn.mobifone.tts_project1.data.Task
import vn.mobifone.tts_project1.databinding.FragmentTasksBinding
import vn.mobifone.tts_project1.util.REQUEST_KEY
import vn.mobifone.tts_project1.util.RESULT_KEY
import vn.mobifone.tts_project1.util.exhaustive
import vn.mobifone.tts_project1.util.onQueryTextChanged
...
class TasksFragment : Fragment(R.layout.fragment_tasks), TasksAdapter.OnItemClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        setFragmentResultListener(REQUEST_KEY) { _, bundle ->
            val result = bundle.getInt(RESULT_KEY)
