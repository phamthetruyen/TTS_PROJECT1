 ...
 */
public abstract class Hilt_AddEditTaskFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddEditTaskFragment() {
    super();
  }

  Hilt_AddEditTaskFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddEditTaskFragment_GeneratedInjector) this.generatedComponent()).injectAddEditTaskFragment(UnsafeCasts.<AddEditTaskFragment>unsafeCast(this));
    }
  }
